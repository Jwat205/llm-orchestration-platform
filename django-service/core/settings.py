"""
Django settings for LLM API Platform
"""
...
DATABASES = {
    'default': {
        ...
        'NAME': config('DB_NAME', default='llm_api'),
...
SPECTACULAR_SETTINGS = {
    'TITLE': 'LLM API Platform',
    'DESCRIPTION': 'Enterprise-grade Large Language Model API platform',
    'VERSION': '1.0.0',
