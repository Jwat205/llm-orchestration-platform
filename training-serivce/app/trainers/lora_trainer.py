# training-service/app/trainers/lora_trainer.py
...
class LoRATrainer:
    def train(self, config: dict) -> dict:
        ...
        model = AutoModelForCausalLM.from_pretrained(model_name, device_map='auto', load_in_4bit=config.get('quant_bits')==4)
        lora_cfg = LoraConfig(
            r=config['lora_r'],
        ...
        args = TrainingArguments(
            output_dir=Settings.OUTPUT_DIR+'/lora',
